  ...
  const handleExpand = async () => {
    ...
    try {
      ...
      if (err?.status === 503) {
        ...
        toaster.show('AI budget exceeded. Upgrade or wait for reset.', 'warning');
      } else {
        toaster.show(err?.message || 'Could not generate brief', 'warning');
      }
    } finally {
      setGenerating(false);
    }
        ...
        <div className="flex items-center gap-[10px] min-w-0">
          ...
          <div className="min-w-0">
            ...
            {cached ? (
              ...
              <p className="text-[12px] text-newTableText truncate">
                {empty ? 'Generate your daily AI summary' : 'Loading…'}
              </p>
            )}
          </div>
        </div>
      ...
      {expanded && (
        <div className="px-[16px] pb-[16px] pt-[4px]">
          {isLoading || generating ? (
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      toaster.show(
                        err?.message || 'Could not regenerate brief',
                        'warning'
                      );
                    } finally {
                      setGenerating(false);
            ...
            <div className="flex flex-col gap-[10px]">
              <p className="text-[13px] text-textColor">
                No brief yet for today. Click above to generate one.
              </p>
            </div>
          )}
        </div>
