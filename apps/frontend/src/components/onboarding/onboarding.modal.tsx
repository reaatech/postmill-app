  ...
  return (
    <div className="flex flex-col gap-[24px]">
      ...
      <div className="flex justify-end pt-[24px] mt-[8px]">
        <button
          onClick={onNext}
          className="group flex items-center gap-[12px] bg-gradient-to-r from-[#2b5cd3] to-[#5e84e8] hover:from-[#3d6ae0] hover:to-[#7397ee] text-white font-semibold px-[32px] py-[14px] rounded-[12px] text-[16px] transition-all shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40"
        >
          {sortedIntegrations.length > 0
            ? t('continue', 'Continue')
...
const OnboardingStep2: FC<{ onBack: () => void; onFinish: () => void }> = ({
  ...
  return (
    <div className="flex flex-col gap-[24px] flex-1">
      <div className="flex gap-[4px] flex-col text-center">
        <div className="text-[24px] font-semibold">
          {t('watch_tutorial_title', 'Learn How to Use Postmill')}
        </div>
        <div className="text-[14px] text-customColor18">
          {t(
            'watch_tutorial_description',
            'Watch this short video to learn how to get the most out of Postmill'
          )}
        </div>
      </div>
