export const testimonials1 = [
  ...
  },
  {
    ...
    content: (
      <>
        I just found out about Postmill, a tool for scheduling social media.{' '}
        {'\n'}
        ...
        {'\n'}
        Postmill seems to focus on just doing one thing well. {'\n'}
        {'\n'}
      </>
    ),
  },
  {
    ...
    content: (
      <>
        As a privacy-first company we appreciate being able to self-host Postmill!
  ...
  },
  {
    ...
    content: (
      <>
        Postmill changed how we manage our social media presence by aggregating
        our platforms into one effective tool. Post scheduling, and AI post
        ideation are two of the many features that come with Postmill, and have
  ...
  },
  {
    ...
    content: (
      <>
        ...
        n8n + Postmill =🔥Never miss a day of posting again: {'\n\n'}→ Easy to get
  ...
  },
  {
    ...
    content: (
      <>
        Manage all your social media accounts from a single place: Postmill, a
...
export const testimonials2 = [
  {
    ...
    content: (
      <>
        🌟 Exciting news! 🚀 I've just started using Postmill, a fantastic new
        ...
        scheduling! 📅✨ {'\n\n'}
        Built with privacy and flexibility in mind, Postmill can run on your own
  ...
  },
  {
    ...
    content: (
      <>
        Postmill makes it so easy to plan ahead. The AI suggestions are relevant,
