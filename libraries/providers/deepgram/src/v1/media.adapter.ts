...
const _meta = new DeepgramAdapter(undefined as unknown as SafeFetchPort);

export const deepgramMediaModule: ProviderModule<any, any> = {
  ...
  create: (rt) => new DeepgramAdapter(rt.fetch),
};
