...
export class SurfsharkAdapter implements VpnCapability {
  ...
  readonly credentialFields: VpnCredentialField[] = [
    {
      ...
      type: 'password',
      required: true,
      placeholder: 'username:password from Surfshark manual setup',
    },
    {
      key: 'configUrl',
      ...
      type: 'text',
      required: false,
      placeholder: 'https://api.surfshark.com/v1/server/configurations/...',
    },
  ];
  ...
  readonly setupNotes =
    'Create manual service credentials in your Surfshark account area. These are used for OpenVPN/WireGuard manual setups.';
...
const _meta: VpnCapability = new SurfsharkAdapter();

export const surfsharkVpnModule: ProviderModule<any, any> = {
