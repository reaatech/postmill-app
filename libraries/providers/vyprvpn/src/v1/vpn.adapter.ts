...
export class VyprvpnAdapter implements VpnCapability {
...
const _meta: VpnCapability = new VyprvpnAdapter();

export const vyprvpnVpnModule: ProviderModule<any, any> = {
  manifest: {
    domain: 'vpn',
