...
const adapter = new OpenAICompatibleAdapter('gmihub', 'GMI Cloud', 'https://api.gmihub.ai/v1', undefined, undefined, 'hub');

export const gmihubAiModule: ProviderModule<any, any> = {
